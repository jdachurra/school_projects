...
def minimax(board, depth=0):
    ...
    if terminal(board):
        ...
        #total_utility = 0
        #move_dictionary = {}  using dictionary, although more readable, uses more space
        for action in actions(board):
            ...
            #first calculate the total utility of the node
            action_utility = minimax(new_node_n, depth+1)
